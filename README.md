...
- `core/theory.js`: pitch-class sets in any equal division: prime forms, Forte numbers, interval vectors, symmetry, transposition and inversion, and chord names spelled for the key.
